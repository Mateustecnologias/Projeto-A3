...
app.post('/chatbox', async (req, res) => { // metodo POST que possibilita receber uma resposta do que foi enviado pela req //
    ...
    res.send(response.data.choices[0].message.content); // caminho na qual a resposta vem do console //
});